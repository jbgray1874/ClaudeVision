...
Yes, you can paste them all into the PowerShell terminal together. PowerShell will run them one after another as separate lines.

So you can paste this whole block in one go:
...
Copy-Item "C:\Users\james.gray\Documents\Codex\2026-04-23-i-m-going-to-give-you\latest_src_pack\src\main.py" "C:\ClaudeVision\src\main.py" -Force
python .\src\main.py --search-root "C:\ClaudeVision\input\drawings" --drawing-pattern "*.PDF"
So no, you do not need to do them one by one.

After it finishes, paste the output over and I’ll help you assess the batch.
