...
def build_process_routing(part: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    if "diamond_polish" in operations:
        routing.append({"operation": "diamond_polish", "phase": "finish", "driver": "polish_requirement", "source": "process_notes"})
    if "glue" in operations:
        routing.append({"operation": "glue", "phase": "assembly", "driver": "bonding_requirement", "source": "process_notes"})
    if "dress_welds" in operations:
        routing.append({"operation": "dress_welds", "phase": "finish", "driver": "weld_dressing", "source": "process_notes"})
