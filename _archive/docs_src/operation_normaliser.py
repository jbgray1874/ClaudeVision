...
AI_TO_SDI: Dict[str, List[str]] = {
    ...
    "handling":         ["MANM", "HAND", "MAN M", "MANA", "MC J"],
    "drilling":         ["DRIL", "PDRIL"],
    "countersinking":   ["COUN"],
    "tapping":          ["TAP"],
    "grinding":         ["GRIN"],
    ...
    # --- additive: engine HOURLY_RATES ops that had no SDI mapping ---
    "punch":                ["PUNC"],          # forward map so punch lines up with PUNC, not DRIL
    "tube":                 ["TUBE"],          # TUBE dept (was unmapped)
    "saw":                  ["SAW"],           # distinct from GUILL
    "cnc_routing":          ["CNCJ"],
    "laser_cutting_acrylic":["LASA", "LASM"],
    "assembly_acrylic":     ["PACP", "PACM"],
    "manual_labour_metal":  ["MANM"],
    "manual_labour_acrylic":["MANA"],
}
...
AI_DISPLAY_LABELS: Dict[str, str] = {
    ...
    "tube":             "Tube Cut / Handle",
    "saw":              "Saw",
    "cnc_routing":      "CNC Routing",
    "laser_cutting_acrylic": "Laser (Acrylic)",
    "assembly_acrylic": "Assembly (Acrylic)",
    "manual_labour_metal":   "Manual Labour (Metal)",
    "manual_labour_acrylic": "Manual Labour (Acrylic)",
}
